...
<div class="p-margin-desktop max-w-container-max mx-auto pb-12 pt-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        <a href="{{ route('admin.employees.index') }}" class="bg-white border border-outline-variant rounded-xl p-5 hover:border-primary/40 transition-colors no-underline">
        ...
        <a href="{{ route('admin.leave-requests.index') }}" class="bg-white border border-outline-variant rounded-xl p-5 hover:border-primary/40 transition-colors no-underline">
            <div class="flex items-center gap-3 mb-3">
        ...
        <a href="{{ route('admin.payroll.index') }}" class="bg-white border border-outline-variant rounded-xl p-5 hover:border-primary/40 transition-colors no-underline">
            <div class="flex items-center gap-3 mb-3">
        ...
        <a href="{{ route('admin.schedule.index') }}" class="bg-white border border-outline-variant rounded-xl p-5 hover:border-primary/40 transition-colors no-underline">
            <div class="flex items-center gap-3 mb-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white border border-outline-variant rounded-xl overflow-hidden">
            <div class="px-5 py-4 border-b border-outline-variant flex items-center justify-between">
                ...
                <a href="{{ route('admin.leave-requests.index') }}" class="font-label-md text-label-md text-primary hover:underline">View all</a>
            </div>
            <div class="divide-y divide-surface-container-high">
                ...
                @empty
                    <div class="px-5 py-10 text-center font-body-md text-secondary">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('admin.leave-requests.index') }}" class="text-primary font-label-md">Open leave requests</a>
                        </div>
                    </div>
                @endforelse
            </div>
        ...
        <div class="bg-white border border-outline-variant rounded-xl overflow-hidden">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a href="{{ route('admin.employees.create') }}" class="flex items-center gap-3 rounded-lg border border-outline-variant px-4 py-3 hover:bg-surface-container-low transition-colors no-underline text-on-surface">
                    <span class="material-symbols-outlined text-primary">person_add</span>
                    <span class="font-body-md text-body-md">Add Employee</span>
                </a>
                <a href="{{ route('admin.payroll.process') }}" class="flex items-center gap-3 rounded-lg border border-outline-variant px-4 py-3 hover:bg-surface-container-low transition-colors no-underline text-on-surface">
                ...
                <a href="{{ route('admin.schedule.create') }}" class="flex items-center gap-3 rounded-lg border border-outline-variant px-4 py-3 hover:bg-surface-container-low transition-colors no-underline text-on-surface">
                    <span class="material-symbols-outlined text-primary">add_circle</span>
                    <span class="font-body-md text-body-md">Add Shift</span>
                </a>
                <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 rounded-lg border border-outline-variant px-4 py-3 hover:bg-surface-container-low transition-colors no-underline text-on-surface">
