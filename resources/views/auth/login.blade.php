...
<style>
    ...
    .social-btn:hover svg {
        transform: scale(1.05); /* Slight icon pop on hover */
    }
...
<div class="container">
    <div class="login-container">
        ...
        <a href="{{ route('portal') }}" class="back-btn d-inline-block mb-4 text-decoration-none">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                    ...
                    <h5 class="fw-bold text-dark m-0">Admin Login</h5>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-custom d-flex align-items-center">
                            ...
                            <button type="button" id="togglePassword" class="input-group-text border-0 bg-transparent" style="cursor: pointer;">
                    ...
                    <button type="submit" class="btn text-white w-100 py-2.5 mb-4 border-0 shadow-sm" style="background-color: #3b3db1; border-radius: 8px; font-weight: 600;">Sign In</button>
                    ...
                    <a href="{{ route('auth.google') }}" class="social-btn mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" class="me-2">
                            <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285f4"/>
                            <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34a853"/>
                            <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" fill="#fbbc05"/>
                            <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#ea4335"/>
                        </svg>
                        <span class="text-dark small fw-semibold">Continue with Google</span>
                    </a>
                    <div class="text-center">
                        <span class="text-muted small">Don't have an account? </span>
                        <a href="{{ route('register') }}" class="text-decoration-none small fw-bold" style="color: #3b3db1;">Create one here</a>
                    </div>
                </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        togglePasswordButton.addEventListener('click', function () {
            ...
            // Toggle the icon classes between eye and eye-slash
            if (type === 'text') {
